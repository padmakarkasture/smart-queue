...
<?php
include "connect.php";
$qu2="select min(tokenno) from tokendb where other=1";
$res=mysqli_query($conn,$qu2);
$row=mysqli_fetch_row($res);

$qu3="select min(tokenno) from tokendb where other=1 and tokenno not in(select min(tokenno) from tokendb where other=1)";
...
<body onload="btn();">
		     ...
		     <div class="sarkaa">
				...
				<div class="contact100-form validate-form">
					...
					<div class="container-contact100-form-btn">
						<?php echo"<a href='deleteother.php?id=".$row[0]."'"; ?>
					...
					<div class="container-contact100-form-btn">
					<?php echo"<a href='other_unresolved.php?id=".$row[0]."'"; ?>
						<button class="contact100-form-btn">
							unresolved
						</button>
</a>
					...
					<div class="container-contact100-form-btn">
					<?php echo"<a href='other_un_list.php'"; ?>
						<button class="contact100-form-btn">
						list of unresolved
						</button>
</a>
	...
	if(empty($row1[0])){
                ?>
                <h1 id='kela' hidden>token number <?php echo $row[0]; ?> go to counter number 3</h1><?php }else{
            ?>
            
            
            <h1 id="kela" hidden>token number <?php echo $row1[0]; ?> go to counter number 3</h1>
