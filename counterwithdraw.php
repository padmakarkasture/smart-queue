...
<?php
include "connect.php";
$qu2="select min(tokenno) from tokendb where withdraw=1";
$res=mysqli_query($conn,$qu2);
$row=mysqli_fetch_row($res);

$qu3="select min(tokenno) from tokendb where withdraw=1 and tokenno not in(select min(tokenno) from tokendb where withdraw=1)";
$res2=mysqli_query($conn,$qu3);
$row1=mysqli_fetch_row($res2); ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<title>WITHDRAW CNTR</title>
	<meta charset="UTF-8">
		     ...
		     <div class="sarkaa">
				...
				<div class="contact100-form validate-form">
					...
					<div class="container-contact100-form-btn">
						<?php echo"<a href='deletewith.php?id=".$row[0]."'"; ?>
					...
					<div class="container-contact100-form-btn">
					<?php echo"<a href='withdraw_unresolved.php?id=".$row[0]."'"; ?>
						<button class="contact100-form-btn">
							unresolved
						</button>
</a>
					...
					<div class="container-contact100-form-btn">
					<?php echo"<a href='withdraw_un_list.php'"; ?>
						<button class="contact100-form-btn">
						list of unresolved
						</button>
</a>
